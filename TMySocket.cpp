...
SOCKET TMySocket::getSocket()
{
	return(_socket) ;
}
//---------------------------------------------------------------------------

int TMySocket::doClose()
{
	return(closesocket(_socket)) ;
}
//---------------------------------------------------------------------------

int TMySocket::getErrorCode()
{
	return(_error_code) ;
}
//---------------------------------------------------------------------------

int TMySocket::receive(char* buf, int len, int flags)
{
	return(recv(_socket, buf, len, flags)) ;
}
//---------------------------------------------------------------------------

int TMySocket::send(char *data, int length, int flags)
{
	return(::send(_socket, data, length, flags)) ;
