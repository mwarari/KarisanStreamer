object StreamsForm: TStreamsForm
  Left = 0
  Top = 0
  ActiveControl = StreamsGrid
  ...
  PixelsPerInch = 96
  TextHeight = 13
  object StreamsGrid: TStringGrid
    Left = 8
    Top = 62
    Width = 441
    Height = 120
    ...
    TabOrder = 0
    OnDblClick = StreamsGridDblClick
    ColWidths = (
      133
      40
      49
  ...
  object AutoConnectCb: TCheckBox
    Left = 8
    Top = 39
    Width = 97
    Height = 17
